...
/*EMPLOYEE*/
--Employee (Ssn, Fname, Lname,Rno, Bdate, Sex)
--Remove the Dno to prevent integrity constraint 
PROMPT Inserting values into 'EMPLOYEE'
INSERT INTO EMPLOYEE VALUES (123456789,'John','Smith',1,TO_DATE('1965-01-09','YYYY-MM-DD'),'M');
INSERT INTO EMPLOYEE VALUES (333445555,'Franklin','Wong',6,TO_DATE('1955-12-08','YYYY-MM-DD'),'M');
INSERT INTO EMPLOYEE VALUES (999887777,'Alicia','Zelaya',9,TO_DATE('1968-01-19','YYYY-MM-DD'),'F');
INSERT INTO EMPLOYEE VALUES (987654321,'Jennifer','Wallace',2,TO_DATE('1941-06-20','YYYY-MM-DD'),'F');
INSERT INTO EMPLOYEE VALUES (666884444,'Ramesh','Narayan',10,TO_DATE('1962-09-15','YYYY-MM-DD'),'M');
INSERT INTO EMPLOYEE VALUES (453453453,'Joyce','English',2,TO_DATE('1972-07-31','YYYY-MM-DD'),'F');
INSERT INTO EMPLOYEE VALUES (987987987,'Ahmad','Jabbar',2,TO_DATE('1969-03-29','YYYY-MM-DD'),'M');
INSERT INTO EMPLOYEE VALUES (888665555,'James','Borg',3,TO_DATE('1937-11-10','YYYY-MM-DD'),'M');
...
INSERT INTO EMPLOYEE VALUES (333445555,'Franklin','T','Wong',6,TO_DATE('1955-12-08','YYYY-MM-DD'),'M',5);
...
INSERT INTO EMPLOYEE VALUES (666884444,'Ramesh','K','Narayan',10,TO_DATE('1962-09-15','YYYY-MM-DD'),'M',5);
...
INSERT INTO PAYSTUB VALUES (1,1,123456789,TO_DATE('01-01-2024','MM-DD-YYYY'),TO_DATE('01-14-2024','MM-DD-YYYY'),2100.00,520.00,1580.00);
INSERT INTO PAYSTUB VALUES (2,2,123456789,TO_DATE('01-29-2024','MM-DD-YYYY'),TO_DATE('02-11-2024','MM-DD-YYYY'),2100.00,520.00,1580.00);
INSERT INTO PAYSTUB VALUES (3,3,123456789,TO_DATE('02-12-2024','MM-DD-YYYY'),TO_DATE('02-25-2024','MM-DD-YYYY'),2100.00,520.00,1580.00);

INSERT INTO PAYSTUB VALUES (4,1,333445555,TO_DATE('02-12-2024','MM-DD-YYYY'),TO_DATE('02-25-2024','MM-DD-YYYY'),2500.00,600.00,1900.00);
INSERT INTO PAYSTUB VALUES (5,2,333445555,TO_DATE('02-26-2024','MM-DD-YYYY'),TO_DATE('03-10-2024','MM-DD-YYYY'),2500.00,600.00,1900.00);

INSERT INTO PAYSTUB VALUES (6,1,999887777,TO_DATE('01-01-2024','MM-DD-YYYY'),TO_DATE('01-14-2024','MM-DD-YYYY'),3000.00,500.00,2500.00);
INSERT INTO PAYSTUB VALUES (7,2,999887777,TO_DATE('01-29-2024','MM-DD-YYYY'),TO_DATE('02-11-2024','MM-DD-YYYY'),3000.00,500.00,2500.00);
INSERT INTO PAYSTUB VALUES (8,3,999887777,TO_DATE('02-12-2024','MM-DD-YYYY'),TO_DATE('02-25-2024','MM-DD-YYYY'),3000.00,500.00,2500.00);
INSERT INTO PAYSTUB VALUES (9,4,999887777,TO_DATE('02-12-2024','MM-DD-YYYY'),TO_DATE('02-25-2024','MM-DD-YYYY'),3000.00,500.00,2500.00);
INSERT INTO PAYSTUB VALUES (10,5,999887777,TO_DATE('02-26-2024','MM-DD-YYYY'),TO_DATE('03-10-2024','MM-DD-YYYY'),3000.00,500.00,2500.00);
